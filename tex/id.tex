...
\title{集群缓存系统负载均衡算法的设计与实现}{}{Design and Implementation of Load Balance Algorithms in Cluster Cache Systems}{}
\author{郑云川}{Yunchuan Zheng}
\advisor{王威}{助理教授}{Wei Wang}{Assistant Prof.}
\coadvisor{肖卿俊}{副教授}{Qingjun Xiao}{Associate Prof.}
